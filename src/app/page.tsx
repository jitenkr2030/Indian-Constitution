...
import SamvidhanSewak from '@/components/phase5/SamvidhanSewak'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-saffron-50 via-white-to-green-50 flex flex-col">
      ...
      <main className="flex-1 pb-20">
          ...
          {!dataSeeded && (
            <Card className="max-w-md mx-auto mb-6 border-orange-200">
              <CardContent className="p-4">
                ...
                <Button onClick={() => setDataSeeded(true)} className="w-full">
                  Load Sample Data
                </Button>
              </CardContent>
            </Card>
        ...
        {/* Main Tabs */}
        <Tabs value={activeTab} onValueChange={setActiveTab} className="px-2 md:px-6">
          <div className="overflow-x-auto">
            <TabsList className="grid w-full grid-cols-22 mb-6 min-w-max">
              <TabsTrigger value="home" data-value="home" className="text-xs md:text-sm">Home</TabsTrigger>
              <TabsTrigger value="browse" data-value="browse" className="text-xs md:text-sm">Browse</TabsTrigger>
              <TabsTrigger value="rights" data-value="rights" className="text-xs md:text-sm">Rights</TabsTrigger>
              <TabsTrigger value="amendments" data-value="amendments" className="text-xs md:text-sm">Amendments</TabsTrigger>
              <TabsTrigger value="learn" data-value="learn" className="text-xs md:text-sm">Learn</TabsTrigger>
              <TabsTrigger value="rti" data-value="rti" className="text-xs md:text-sm">RTI</TabsTrigger>
              <TabsTrigger value="emergency" data-value="emergency" className="text-xs md:text-sm">Emergency</TabsTrigger>
              <TabsTrigger value="consumer" data-value="consumer" className="text-xs md:text-sm">Consumer</TabsTrigger>
              <TabsTrigger value="banking" data-value="banking" className="text-xs md:text-sm">Banking</TabsTrigger>
              <TabsTrigger value="gov-services" data-value="gov-services" className="text-xs md:text-sm">Gov</TabsTrigger>
              <TabsTrigger value="womens-rights" data-value="womens-rights" className="text-xs md:text-sm">Women</TabsTrigger>
              <TabsTrigger value="environment" data-value="environment" className="text-xs md:text-sm">Environment</TabsTrigger>
              <TabsTrigger value="digital-rights" data-value="digital-rights" className="text-xs md:text-sm">Digital</TabsTrigger>
              <TabsTrigger value="healthcare" data-value="healthcare" className="text-xs md:text-sm">Health</TabsTrigger>
              <TabsTrigger value="education" data-value="education" className="text-xs md:text-sm">Education</TabsTrigger>
              <TabsTrigger value="housing" data-value="housing" className="text-xs md:text-sm">Housing</TabsTrigger>
              <TabsTrigger value="agriculture" data-value="agriculture" className="text-xs md:text-sm">Agri</TabsTrigger>
              <TabsTrigger value="journalism" data-value="journalism" className="text-xs md:text-sm">Journal</TabsTrigger>
              <TabsTrigger value="business" data-value="business" className="text-xs md:text-sm">Business</TabsTrigger>
              <TabsTrigger value="nri" data-value="nri" className="text-xs md:text-sm">NRI</TabsTrigger>
              <TabsTrigger value="library" data-value="library" className="text-xs md:text-sm">Library</TabsTrigger>
              <TabsTrigger value="samvidhan-sewak" data-value="samvidhan-sewak" className="text-xs md:text-sm">Sewak</TabsTrigger>
            </TabsList>
          </div>
          ...
          <TabsContent value="samvidhan-sewak">
            <SamvidhanSewak />
          </TabsContent>
        </Tabs>
      </main>
